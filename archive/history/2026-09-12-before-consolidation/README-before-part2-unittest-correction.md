...
Python 3.11, pandas e scikit-learn para preparação e modelagem; Pydantic para validar a saída; Joblib para persistir o pipeline; Streamlit para o teste interativo; Pytest para os testes; e Docker para a execução reproduzível.
