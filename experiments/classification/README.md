...
- `experiments/classification/e01_unigram`: baseline textual e auditoria de erros/features;
- `experiments/classification/e02_balanced`: efeito isolado de pesos balanceados e auditoria específica dos novos erros;
- `experiments/classification/e03_bigrams`: efeito isolado de unigramas + bigramas;
- `experiments/classification/e04_moderate_weights`: pesos intermediários, auditoria e candidato final;
- `pyproject.toml`, na raiz: fonte única das dependências compartilhadas.
